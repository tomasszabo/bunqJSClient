...
class RequestResponse {
     ...
     * @returns {Promise<any>}
     */
    get(userId, monetaryAccountId, requestResponseId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield limiter.run(() => __awaiter(this, void 0, void 0, function* () {
                return this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/request-response/${requestResponseId}`);
            }));
    ...
    list(userId, monetaryAccountId, options = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield limiter.run(() => __awaiter(this, void 0, void 0, function* () {
                return this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/request-response`, {}, {
                    axiosOptions: {
                        params: params
                    }
                });
     ...
     */
    put(userId, monetaryAccountId, requestResponseId, status, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield limiter.run(() => __awaiter(this, void 0, void 0, function* () {
                return this.ApiAdapter.put(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/request-response/${requestResponseId}`, requestOptions);
            }));
            return response.Response;
        });
    }
