...
class MonetaryAccount {
     ...
     * @returns {Promise<any>}
     */
    get(userId, monetaryAccountId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const limiter = this.ApiAdapter.RequestLimitFactory.create("/monetary-account", "GET");
            const response = yield limiter.run(() => __awaiter(this, void 0, void 0, function* () { return this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}`); }));
    ...
    list(userId, options = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield limiter.run(() => __awaiter(this, void 0, void 0, function* () {
                return this.ApiAdapter.get(`/v1/user/${userId}/monetary-account`, {}, {
                    axiosOptions: {
                        params: params
                    }
                });
