...
class MasterCardAction {
     ...
     * @returns {Promise<any>}
     */
    get(userId, monetaryAccountId, masterCardActionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield limiter.run(() => __awaiter(this, void 0, void 0, function* () {
                return this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/mastercard-action/${masterCardActionId}`);
            }));
    ...
    list(userId, monetaryAccountId, options = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield limiter.run(() => __awaiter(this, void 0, void 0, function* () {
                return this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/mastercard-action`, {}, {
                    axiosOptions: {
                        params: params
                    }
                });
