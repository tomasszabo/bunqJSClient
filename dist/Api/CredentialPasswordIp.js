...
class CredentialPasswordIp {
     ...
     */
    get(userId, credentialPasswordIpId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const limiter = this.ApiAdapter.RequestLimitFactory.create("/credential-password-ip", "GET");
            const response = yield limiter.run(() => __awaiter(this, void 0, void 0, function* () { return this.ApiAdapter.get(`/v1/user/${userId}/credential-password-ip/${credentialPasswordIpId}`); }));
    ...
    list(userId, options = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield limiter.run(() => __awaiter(this, void 0, void 0, function* () {
                return this.ApiAdapter.get(`/v1/user/${userId}/credential-password-ip`, {}, {
                    axiosOptions: {
                        params: params
                    }
                });
