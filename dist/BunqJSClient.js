...
class BunqJSClient {
    ...
    constructor(storageInterface = store, loggerInterface = Logger_1.default) {
        ...
        this.api = {
            ...
            avatar: new Avatar_1.default(this.ApiAdapter),
    ...
    install() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.Session.verifyInstallation() === false) {
                ...
                const response = yield this.api.installation.add();
                // update the session properties
                this.Session.serverPublicKeyPem = response.serverPublicKey;
                this.Session.serverPublicKey = yield Rsa_1.publicKeyFromPem(response.serverPublicKey);
                ...
                // update storage
                yield this.Session.storeSession();
            }
            return true;
        });
    }
     ...
     * @returns {Promise<boolean>}
     */
    registerDevice(deviceName = "My Device") {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.Session.verifyDeviceInstallation() === false) {
                try {
                    const deviceId = yield this.api.deviceRegistration.add({
                    ...
                    if (response.status === 400) {
                        ...
                        yield this.Session.setupKeypair(true);
    ...
    generateSession() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                response = yield this.api.sessionServer.add();
            }
            catch (error) {
    ...
    createCredentials() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield limiter.run(() => __awaiter(this, void 0, void 0, function* () {
                return this.ApiAdapter.post(`https://api.tinker.bunq.com/v1/credential-password-ip-request`, {}, {}, {
    ...
    checkCredentialStatus(uuid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield limiter.run(() => __awaiter(this, void 0, void 0, function* () {
                return this.ApiAdapter.get(`https://api.tinker.bunq.com/v1/credential-password-ip-request/${uuid}`, {}, {
                    disableVerification: true,
                    disableSigning: true,
                    skipSessionCheck: true
                });
     ...
     */
    exchangeOAuthToken(clientId, clientSecret, redirectUri, code, state = false, sandbox = false, grantType = "authorization_code") {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    destroySession() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.Session.verifyInstallation() &&
                ...
                try {
                    yield this.api.sessionServer.delete();
                }
                catch (ex) { }
            }
            ...
            yield this.Session.destroySession();
        });
    }
    /**
    ...
    destroyApiSession(save = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.clearExpiryTimer();
            // destroy the stored session
            yield this.Session.destroyApiSession(save);
        });
    }
    /**
     ...
     * @returns {any}
     */
    getUser(userType, updated = false) {
        return __awaiter(this, void 0, void 0, function* () {
            if (updated) {
                // update the user info and update session data
                const userList = yield this.api.user.list();
